...
(function($){
  ...
  var ItemView = Backbone.View.extend({
    ...
    events: {
      ...
      'click span.delete': 'remove_1' // when click on delete, remove_1 call back method is called
    },

    // `initialize()` now binds model change/removal to the corresponding handlers below.
    initialize: function(){
    _.bindAll(this, 'render', 'unrender_1', 'swap', 'remove_1'); // every function that uses 'this' as the current object should be in here

      this.model.bind('change', this.render);
      this.model.bind('remove', this.unrender_1); // removing a model will trigger the unrender_1 method
    },
